    ...
    <>
      {compact ? (
        <div className="relative">
          <button onClick={() => setShowProfileMenu(!showProfileMenu)} className="w-7 h-7 bg-black text-white flex items-center justify-center text-xs font-bold">
            {userInitial}
          </button>
          {showProfileMenu && (
            <div className="absolute right-0 top-10 w-56 bg-white border border-gray-200 shadow-lg z-50">
